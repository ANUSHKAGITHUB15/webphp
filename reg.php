...
$sql = "INSERT INTO `users` (`id`, `name`, `username`, `email`, `password`) VALUES (NULL, '$name', '$uname', '$uemail', '$pas');";
...
try {
   ...
   // $mail->SMTPDebug = SMTP::DEBUG_SERVER;                      //Enable verbose debug output
    ...
    $mail->Username   = 'anushkx.15@gmail.com';                     //SMTP username
    $mail->Password   = 'uyrh ydxq cntj prpo';                                //SMTP password
